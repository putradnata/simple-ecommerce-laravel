    ...
    @section('cardBody')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                @else
                    <option value="BCA"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>BCA</option>
                    <option value="BNI"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>BNI</option>
                    <option value="BRI"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>BRI</option>
                    <option value="Mandiri"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>Mandiri
                    </option>
                    <option value="Cimb Niaga"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>Cimb Niaga
                    </option>
                    <option value="Permata Bank"
                        {{ old('bank') == ($bank->bank ? 'selected' : $bank->bank == '') ? 'selected' : '' }}>Permata Bank
                    </option>
                @endif
                </select>
                {{-- error message for input type above --}}
